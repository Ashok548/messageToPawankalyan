                    ...
                    <Box sx={{ p: { xs: 3, sm: 4 } }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
                            ...
                            {isSuperAdmin && leader.status !== 'APPROVED' && (
                                <Button
                                    ...
                                    size="small"
                                >
                                    {updating ? tCommon('approving') : tCommon('approve')}
                                </Button>
                            )}
                        </Box>
                        ...
                        <Box sx={{ pt: 3, borderTop: '1px solid #e0e0e0' }}>
                            <Typography variant="body2" color="text.secondary">
                                {t('profile.submitted')}: {formatDate(leader.createdAt)}
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                                {t('profile.submittedBy')}: {getSubmittedByLabel(leader.submittedBy)}
                            </Typography>
                        </Box>
                    </Box>
                </Paper>
