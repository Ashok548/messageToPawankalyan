...
export default function CreateDisciplinaryCasePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.leaderName || !formData.position) {
            setError('Please fill in leader name and position');
            return;
        }
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                required
                                helperText="Enter the full name of the leader"
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                onChange={handleInputChange}
                                required
                                helperText="e.g., MLA, MP, District President, etc."
                            />
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                {leaderPhotoFile ? leaderPhotoFile.name : 'Upload Leader Photo (Optional)'}
                                <input
                                    type="file"
                                    hidden
                                    accept="image/*"
                        ...
                        <Grid item xs={12}>
                            ...
                            <Typography variant="caption" color="text.secondary" display="block" sx={{ mb: 2 }}>
                                Add URLs to news articles, social media posts, or other references
                            </Typography>
                            <Stack spacing={2}>
